...
export default function AboutMe(props) {
  const technologies = [
    ['React JS', 'JavaScript (ES6+)', 'HTML' , 'Bootstrap','CSS', ],
    ['jQuery', 'Github', 'Laravel', 'SQL', 'Tailwind CSS'],
  ]
  return (
    <div
      id="aboutSection"
          ...
          <div className="w-full md:w-7/12 space-y-4 sm:text-base text-sm ">
            <div className="font-Header ">
              <span className="text-gray-400 ">
                Hello! My name is Souvik, and I am a passionate software
                developer and problem solver, dedicated to crafting scalable and
                efficient solutions that enhance user satisfaction and drive
                business growth. My journey in web development began in 2022
                when I eneterd into the world of IT Industry. Little did I know that programming skills would become
                essential in pursuing this interest, marking the start of my
                programming journey.
              </span>
            </div>
            <div className="font-Header ">
              <span className="text-gray-400 ">
                ...
                <span className="text-AAsecondary">AchieveX Solutions pvt ltd</span>, where I
                played a key role as a {' '}

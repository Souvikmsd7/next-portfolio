...
export default function MyName(props: { finishedLoading: boolean }) {
  ...
  return (
    ...
    >
      ...
      >
        I&apos;m a <span className="text-AAsecondary">software developer</span>, i possess strong problem-solving skills and
        ...
        <span> My journey in software development began with a fascination for creating dynamic user experiences and a passion for 
          optimizing workflows. I excel in crafting scalable and efficient solutions that enhance user satisfaction and drive 
          business growth. In collaborative environments, I thrive on tackling complex challenges and driving innovation. Beyond 
          work, I remain active in exploring new technologies and developing projects. Always eager to learn and grow, I seize every 
          opportunity to expand my skills and insights.</span>
      </motion.h3>
      <motion.div
        initial={{ y: 10, opacity: 0 }}
        animate={{ y: 0, opacity: 1 }}
